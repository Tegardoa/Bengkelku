            ...
            <form class="uk-form-stacked" action="action/act_daftar.php" method="post">
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" id="form-stacked-text" type="text" name="username" placeholder="Masukkan Username" maxlength="15" required>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" id="form-stacked-text" type="password" name="password" placeholder="Masukkan Password" autocomplete="off" maxlength="15"  required>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" id="form-stacked-text" type="text" name="nama" placeholder="Masukkan Nama Lengkap" maxlength="30" required>
                    </div>
                </div>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" id="form-stacked-text" type="date" name="tgl_lahir" min='1910-01-01' max="<?php echo date('Y-m-d');?>" required>
                    </div>
                </div>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" id="form-stacked-text" type="number" name="no_telp" maxlength="15" placeholder="Masukkan Nomor Telepon" required>
                    </div>
                </div>
                
                <div class="uk-margin">
                    <label class="uk-form-label" for="form-stacked-select">Alamat</label>
                    <textarea class="uk-textarea" rows="3" name="alamat" maxlength="50" placeholder="Masukkan Alamat" required></textarea>
                </div>
